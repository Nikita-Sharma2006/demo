  ...
  return (
    <section className="mx-auto flex max-w-md px-4 py-16 sm:px-6 lg:px-8">
      <div className="w-full rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-950">Verify registration</h1>
          <p className="mt-2 text-sm text-slate-600">Enter the OTP sent to your email to finish setting up your account.</p>
        </div>
